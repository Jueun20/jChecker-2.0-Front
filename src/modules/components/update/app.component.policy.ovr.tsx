...
export default function OverridingDialog(props: DialogRawUtilProp) {
    ...
    const handleDelete = () => {
        ...
        props.onSubmit("overriding", false, [], 0, 0);
        setOpen(false);
    }
    ...
    const handleResOvr = () => {
        ...
        props.onSubmit("overriding", true, required, deduct, max_deduct);
        setOpen(false);
    }
    ...
    return (
        ...
        <DialogContent dividers>
            ...
            <DialogActions>
                ...
                <Button onClick={handleResOvr} color="primary">
                    {t('submit')}
                </Button>
            </DialogActions>
        </Dialog>
